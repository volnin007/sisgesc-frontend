...
import { LayoutDashboard, Users, GraduationCap, ClipboardCheck, FileText, BookOpen, Bot } from 'lucide-react';
  ...
  return (
    <aside className="w-64 bg-[#0a0f1a] text-white min-h-screen p-4 flex flex-col border-r border-cyan-500/10">
      ...
      <div className="mt-6 pt-4 border-t border-white/10 text-center space-y-2">
        ...
        <p className="text-[9px] text-gray-500">Escola Municipal Dimas Nasser<br />Gestão 2025/2028</p>
      </div>
    </aside>
  );
}
